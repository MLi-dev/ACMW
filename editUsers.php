...
$sql = "UPDATE `$databasename`.`Users` SET `UserNumber` = $usernumber, `FirstName` = \"$firstname\", `LastName` = \"$lastname\", `Username` = $username, `Password` = \"$password\", `Email` = \"$email\" WHERE `UserNumber` = $usernumber";
